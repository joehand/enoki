...
function panel () {
  return async function (state, emitter) {
    ...
    function handleUpdate (data) {
      assert.strictEqual(typeof data, 'object', 'enoki: data must be type object')
      assert.strictEqual(typeof data.url, 'string', 'enoki: data.url must be type string')
      assert.strictEqual(typeof data.data, 'object', 'enoki: data.data must be type string')
    ...
    async function handleSave (data) {
      assert.strictEqual(typeof data, 'object', 'enoki: arg1 must be type object')
      assert.strictEqual(typeof data.path, 'string', 'enoki: arg1.path must be type string')
      assert.strictEqual(typeof data.url, 'string', 'enoki: arg1.url must be type string')
      assert.strictEqual(typeof data.data, 'object', 'enoki: arg1.data must be type object')
    ...
    async function handlePageAdd (data) {
      assert.strictEqual(typeof data, 'object', 'enoki: data must be type object')
      assert.strictEqual(typeof data.path, 'string', 'enoki: data.path must be type string')
      assert.strictEqual(typeof data.url, 'string', 'enoki: data.url must be type string')
      assert.strictEqual(typeof data.title, 'string', 'enoki: data.title must be type string')
      assert.strictEqual(typeof data.view, 'string', 'enoki: data.view must be type string')
    ...
    async function handleFilesAdd (data) {
      ...
      assert.strictEqual(typeof data.url, 'string', 'enoki: data.url must be type string')
      assert.strictEqual(typeof data.path, 'string', 'enoki: data.path must be type string')
      assert.strictEqual(typeof data.files, 'object', 'enoki: data.files must be type object')
