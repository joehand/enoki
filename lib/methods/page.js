...
function getViews (props) {
  assert.strictEqual(typeof props, 'object', 'enoki arg1 props must be type object')
  assert.strictEqual(typeof props.blueprint, 'object', 'enoki arg1 props.blueprint must be type object')
  assert.strictEqual(typeof props.blueprints, 'object', 'enoki arg1 props.blueprints must be type object')
